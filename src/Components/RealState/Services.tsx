...
const exploreItems = [
  ...
  },
  {
    ...
    title: " Premium properties in prime commercial zones",
    one: "Leasing of High-Street Shops & Malls",
    two: "Office Spaces, Business Parks, Co-working Solutions",
    three: "Corporate Expansion & Investment Opportunities",
    image: "/realhome/two.jpg",
  },
  {
    subtitle: "Industrial Real Estate",
    title: " Trusted by leading manufacturing brands ",
    one: "Buy/Sell/Lease of Plots, Warehouses, and Logistics Parks ",
