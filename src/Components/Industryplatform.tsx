...
//                   <div className="text-white text-left mt-8 mb-8 md:mt-0 mb-0 md:text-left mx-auto">
  ...
  return (
    <section className="w-full md:px-6 lg:px-16">
      ...
      <div className="mt-8">
        <div className="mx-auto px-4 md:px-2">
          <div className="relative">
            <div className="flex md:justify-center gap-4 md:gap-10 overflow-x-auto md:overflow-x-visible">
              {TABS.map((t, i) => (
                <button
                  key={t.title}
                  onClick={() => setActive(i)}
        ...
        <div className="mt-8 flex justify-center">
          <div className="relative rounded-[5px] overflow-hidden w-full">
            <div className="relative h-[370px] md:h-[460px]">
              ...
              <div className="absolute inset-0 flex items-center">
                <div className="w-full md:max-w-4xl p-6 md:p-18">
                  <div className="text-white text-left mt-8 mb-8 md:mt-0 md:text-left mx-auto">
                    <h2 className="text-2xl md:text-3xl font-semibold leading-tight">
                      {TABS[active].headline}
                    </h2>
                    <p className="mt-4 text-sm md:text-[15px] text-gray-200">
